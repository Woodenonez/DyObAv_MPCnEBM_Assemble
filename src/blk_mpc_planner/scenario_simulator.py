...
class Simulator:
    ...
    def load_map_and_obstacles(self, test_graph_index=11):
        if self.idx == 0:
            from blk_mpc_planner.test_maps.test_graphs import Graph
            from blk_mpc_planner.obstacle_scanner.test_dynamic_obstacles import ObstacleScanner
            ...
            from blk_mpc_planner.test_maps.mmc_graph import Graph
            from blk_mpc_planner.obstacle_scanner.mmc_dynamic_obstacles import ObstacleScanner
            ...
            from blk_mpc_planner.test_maps.mmc_graph2 import Graph
            from blk_mpc_planner.obstacle_scanner.mmc_dynamic_obstacles2 import ObstacleScanner
            ...
            from blk_mpc_planner.test_maps.mmc_graph import Graph
            from blk_mpc_planner.obstacle_scanner.crash_dynamic_obstacles import ObstacleScanner
            self.start = (0.6, 3.5, math.radians(0))
            self.waypoints = [(15.4, 3.5, math.radians(0))]
            ...
            from blk_mpc_planner.test_maps.mmc_graph import Graph
            from blk_mpc_planner.obstacle_scanner.follow_dynamic_obstacles import ObstacleScanner
            self.start = (0.6, 3.5, math.radians(0))
            self.waypoints = [(15.4, 3.5, math.radians(0))]
            self.graph = Graph(inflate_margin=self.inflate_margin, with_stc_obs=False)
            self.scanner = ObstacleScanner()
