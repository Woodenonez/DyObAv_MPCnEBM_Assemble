...
def prepare_map(scene:str, root_dir:str, inversed_pixel:bool=False):
    ...
    if scene.lower() == 'assemble':
        ...
        the_map = utils_sl.read_obj_from_json(map_file_path)[0]
    else:
...
def prepare_params(config_file_name:str, root_dir:str):
